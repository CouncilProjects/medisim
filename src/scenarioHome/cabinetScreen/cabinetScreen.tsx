...
export default function CabinetScreen() {
  ...
  useClickOutside(
    ...
    ['click'],
    [control, document.getElementById("medicineHelpBtn")]
  );
    ...
    <Center w="100vw" h="100vh" bg="rgba(0,0,0,0.75)" p="sm">
      ...
      >
        ...
        <Section title="Procedures & Tests" color="blue.4">
          <SimpleGrid cols={4} spacing={10}>
            <ActionCard label="Monitor" color="#868e96" icon={<IconClock size={20} />}
              onClick={() => eventBus.emit('buttonPressed', { action: 'wait' })} />
            <ActionCard label="Physical examination" color="#4dabf7" icon={<IconFlask size={20} />}
...
const onlineHelp: PageHelp = {
  ...
  activeSections: [
    ...
    },
    {
      ...
      steps: [
        {
          stepContent: "Επιτρέπει να περάσει χρόνος χωρίς να χορηγηθεί κάποια θεραπεία ή να πραγματοποιηθεί κάποια ενέργεια. Χρήσιμο όταν θέλετε να παρακολουθήσετε την εξέλιξη της κατάστασης του ασθενούς."
        }
      ]
    },
    {
      ...
      steps: [
        {
          stepContent: "Πραγματοποιεί όλες τις βασικές διαθέσιμες εξετάσεις και παρέχει γενικές πληροφορίες για την κατάσταση του ασθενούς."
        }
      ]
    },
    {
      ...
      steps: [
        {
          stepContent: "Εκτελεί αιματολογική εξέταση και εμφανίζει αποτελέσματα σχετικά με το αίμα του ασθενούς, βοηθώντας στη διάγνωση παθολογικών καταστάσεων."
        }
      ]
    },
    {
      ...
      steps: [
        {
          stepContent: "Μετρά τα επίπεδα χοληστερόλης του ασθενούς και μπορεί να βοηθήσει στην αναγνώριση καρδιαγγειακών προβλημάτων ή μεταβολικών διαταραχών."
        }
      ]
    },
    {
